...
**What NOT to review yet:** visual design (the Figma design comes next) and content — every scheme fact on these pages is a marked placeholder, to be replaced with verified information from official sources.

Fully static, works offline once loaded, collects no personal data.
